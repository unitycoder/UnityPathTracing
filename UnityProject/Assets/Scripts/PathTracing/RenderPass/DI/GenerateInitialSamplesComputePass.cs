...
{
    public class GenerateInitialSamplesComputePass : ScriptableRenderPass
    {
        ...
        public GenerateInitialSamplesComputePass(ComputeShader computeShader)
        {
        ...
        {
            using var builder = renderGraph.AddUnsafePass<PassData>("GIS_Compute", out var passData);
