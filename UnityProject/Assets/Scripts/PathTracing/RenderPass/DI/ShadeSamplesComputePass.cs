...
{
    public class ShadeSamplesComputePass : ScriptableRenderPass
    {
        ...
        public ShadeSamplesComputePass(ComputeShader computeShader)
        {
        ...
        {
            using var builder = renderGraph.AddUnsafePass<PassData>("ShadeSamples_Compute", out var passData);
