...
namespace Rtxdi
{
    ...
    public class ImportanceSamplingContext
    {
        ...
        private ReSTIRPTContext                    m_restirPTContext;
        ...
        public ImportanceSamplingContext(ImportanceSamplingContext_StaticParameters isParams)
        {
            ...
            m_localLightRISBufferSegmentParams.bufferOffset =
                m_risBufferSegmentAllocator.AllocateSegment(
                    isParams.localLightRISBufferParams.tileCount * isParams.localLightRISBufferParams.tileSize);
            ...
            m_environmentLightRISBufferSegmentParams.bufferOffset =
                m_risBufferSegmentAllocator.AllocateSegment(
                    isParams.environmentLightRISBufferParams.tileCount * isParams.environmentLightRISBufferParams.tileSize);
            ...
            var restirPTStaticParams = new ReSTIRPTStaticParameters
            {
                CheckerboardSamplingMode = isParams.CheckerboardSamplingMode,
                RenderWidth              = isParams.renderWidth,
                RenderHeight             = isParams.renderHeight,
            };
            m_restirPTContext = new ReSTIRPTContext(restirPTStaticParams);
        }
        ...
        public ReSTIRPTContext  GetReSTIRPTContext()   => m_restirPTContext;
        ...
        {
            return m_restirDIContext.GetInitialSamplingParameters().localLightSamplingMode
