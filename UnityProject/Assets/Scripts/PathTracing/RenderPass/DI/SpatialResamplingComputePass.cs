...
{
    public class SpatialResamplingComputePass : ScriptableRenderPass
    {
        ...
        public SpatialResamplingComputePass(ComputeShader computeShader)
        {
        ...
        {
            using var builder = renderGraph.AddUnsafePass<PassData>("SpatialResampling_Compute", out var passData);
